...
open (OUT_A, ">", "${output_prefix}A.txt") or die "Cannot open ${output_prefix}A.txt. $!\n";
open (OUT_B, ">", "${output_prefix}B.txt") or die "Cannot open ${output_prefix}B.txt. $!\n";
open (OUT_C, ">", "${output_prefix}C.txt") or die "Cannot open ${output_prefix}C.txt. $!\n";
open (OUT_E, ">", "${output_prefix}E.txt") or die "Cannot open ${output_prefix}E.txt. $!\n";
open (OUT_G, ">", "${output_prefix}G.txt") or die "Cannot open ${output_prefix}G.txt. $!\n";
open (OUT_H, ">", "${output_prefix}H.txt") or die "Cannot open ${output_prefix}H.txt. $!\n";
open (OUT_I, ">", "${output_prefix}I.txt") or die "Cannot open ${output_prefix}I.txt. $!\n";
open (OUT_J, ">", "${output_prefix}J.txt") or die "Cannot open ${output_prefix}J.txt. $!\n";
open (OUT_K, ">", "${output_prefix}K.txt") or die "Cannot open ${output_prefix}K.txt. $!\n";
open (OUT_L, ">", "${output_prefix}L.txt") or die "Cannot open ${output_prefix}L.txt. $!\n";
open (OUT_U, ">", "${output_prefix}U.txt") or die "Cannot open ${output_prefix}U.txt. $!\n";

my %MacrostatePopulations = ();
$MacrostatePopulations{"A"} = 0;
$MacrostatePopulations{"B"} = 0;
$MacrostatePopulations{"C"} = 0;
$MacrostatePopulations{"E"} = 0;
$MacrostatePopulations{"G"} = 0;
$MacrostatePopulations{"H"} = 0;
$MacrostatePopulations{"J"} = 0;
$MacrostatePopulations{"K"} = 0;
$MacrostatePopulations{"L"} = 0;
$MacrostatePopulations{"U"} = 0;
