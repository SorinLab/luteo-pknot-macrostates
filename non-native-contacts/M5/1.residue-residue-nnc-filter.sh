...
../1.residue-residue-nnc-filter.pl $NATIVE_CONTACTS $ALL_CONTACT $CUTOFF_PERCENT $CONTACT_DISTANCE $NC_DISTANCE $OUTPUT $OUTPUT_EXCLUDED $OUTPUT_INCLUDED &> 1.IOs/1.stdout.log